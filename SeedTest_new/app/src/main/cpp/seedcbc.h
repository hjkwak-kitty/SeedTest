...
JNIEXPORT jint JNICALL Java_com_example_hjkwak_seedtestNew_SEEDCBC_seedCBCInit(JNIEnv* env, jobject thiz, jbyteArray userKey, jintArray seedKey);
JNIEXPORT void JNICALL Java_com_example_hjkwak_seedtestNew_SEEDCBC_encryptBlock(JNIEnv* env, jobject thiz, jbyteArray In, jbyteArray Out, jint out_index, jintArray seed_key_);
JNIEXPORT jint JNICALL Java_com_example_hjkwak_seedtestNew_SEEDCBC_internalSeedCBCProcessEnc(JNIEnv* env, jobject thiz, jint enc, jbyteArray seedKey, jbyteArray ivec, jbyteArray cbc_buffer, jintArray buffer_length, jbyteArray inputText, jint inputOffset, jint inputTextLen, jbyteArray outputText, jint outputOffset);
JNIEXPORT jint JNICALL Java_com_example_hjkwak_seedtestNew_SEEDCBC_internalSeedCBCProcessDec(JNIEnv* env, jobject thiz, jint enc, jbyteArray seedKey, jbyteArray ivec, jbyteArray cbc_buffer, jintArray buffer_length, jbyteArray cbc_last_block, jintArray last_block_flag, jbyteArray inputText, jint inputOffset, jint inputTextLen, jbyteArray outputText, jint outputOffset);
JNIEXPORT jint JNICALL Java_com_example_hjkwak_seedtestNew_SEEDCBC_internalSeedProcessBlocks(JNIEnv* env, jobject thiz, jintArray seedKey, jbyteArray ivec, jbyteArray cbc_buffer, jbyteArray outputText, jint outputTextLen);
#ifdef  __cplusplus
}
#endif
